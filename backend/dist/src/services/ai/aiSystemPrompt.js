...
exports.AI_CHAT_FALLBACK_ANSWER = void 0;
exports.buildSystemPrompt = buildSystemPrompt;
const INSTAGRAM_URL = "https://www.instagram.com/alfajorescorrentinos/";
const WHATSAPP_URL = "https://wa.me/5493794632610?text=Hola,%20buenas%20te%20quiero%20consultar%20sobre%20....";
 ...
 */
function sesionContext(userRole) {
    if (userRole === "anonimo") {
...
function seccionesContext(pointsEnabled, userRole) {
...
function compraContext(whatsappCatalogMode, userRole) {
...
function puntosReglas(pointsEnabled) {
    if (!pointsEnabled) {
...
function buildSystemPrompt({ pointsEnabled, whatsappCatalogMode, userRole, }) {
    const anonimo = userRole === "anonimo";
...
exports.AI_CHAT_FALLBACK_ANSWER = `En este momento el asistente está descansando. Ante cualquier duda, te podés comunicar con nosotros vía [Instagram](${INSTAGRAM_URL}), por nuestro [WhatsApp](${WHATSAPP_URL}) o en la sección de [Mensajes](/soporte) de la app.`;
